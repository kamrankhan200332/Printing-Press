...
const Footer = () => {
  ...
  const accordion = [
    {
      ...
      heading: "SUBLIMATION PRINTING",
      subCategories: [
        { subCat: "Mug Printing", url: "/mug" },
        { subCat: "T-Shirt Printing", url: "/tShirt" },
        { subCat: "Cap Printing", url: "/cap" },
        { subCat: "Cushion Printing", url: "/cushion" },
        { subCat: "Tea Coaster Printing", url: "/teaCoaster" },
      ],
    },
    {
      id: 2,
      heading: "OFFSET PRINTING",
      subCategories: [
        { subCat: "Business Cards Printing", url: "/businessCard" },
        { subCat: "Letterhead Printing", url: "/letterhead" },
        { subCat: "Bill Book Printing", url: "/billBook" },
        { subCat: "Notepad Printing", url: "/notepad" },
        { subCat: "Brochure Printing", url: "/brochure" },
      ],
    },
    {
      id: 3,
      heading: "STATIONERY PRINTING",
      subCategories: [
        { subCat: "Rubber Stamp", url: "/rubber" },
        { subCat: "PVC Cards Printing", url: "/pvcCard" },
        { subCat: "Canvas Printing", url: "/canvas" },
        { subCat: "Round Badges", url: "/roundBadge" },
        { subCat: "Award Shields", url: "/awardShield" },
      ],
    },
    {
      id: 4,
      heading: "LARGE FORMAT PRINTING",
      subCategories: [
        { subCat: "Panaflex Printing", url: "/panaflex" },
        { subCat: "Signboard Makers", url: "/signboardMaker" },
        { subCat: "Flag Printing", url: "/flag" },
        { subCat: "Rollup Standee", url: "/rollupStandee" },
        { subCat: "One Vision Printing", url: "/brochure" },
      ],
    },
    {
      id: 5,
      heading: "EMBROIDERY PRINTING",
      subCategories: [
        { subCat: "Clothing Labels", url: "/clothingLabel" },
        { subCat: "School Badges", url: "/schoolBadge" },
        { subCat: "School Sash", url: "/schoolSash" },
        { subCat: "School Tie", url: "/schoolTie" },
        { subCat: "Woven Tags", url: "/wovenTag" },
      ],
    },
    {
      id: 6,
      heading: "UV PRINTING",
      subCategories: [
        { subCat: "Pen Printing", url: "/clothingLabel" },
        { subCat: "Diary Printing", url: "/schoolBadge" },
        { subCat: "Black Mug Printing", url: "/schoolSash" },
        { subCat: "Mobile Cover", url: "/schoolTie" },
        { subCat: "Water Bottles", url: "/wovenTag" },
      ],
    },
  ];
  ...
  return (
    <motion.div
      ...
      className="px-[30px] md:px-[40px] xl:px-[70px] pt-8 bg-black font-['Playfair_Display']"
    >
      <div className="space-y-10">
        <div className="head space-y-5 flex flex-col items-center">
          <h1 className="text-yellow-600 text-xl md:text-xl xl:text-2xl font-bold text-center">
